...
def main(url, model="tiny.en", language=None, interval=5, history_buffer_size=0, preferred_quality="audio_only",
         use_vad=False, direct_url=False, faster_whisper_args=None, **decode_options):
    ...
    try:
        while ffmpeg_process.poll() is None:
            ...
            if clear_buffers or previous_text.has_repetition():
                audio_buffer.clear()
                previous_text.clear()
            trans = translator.translate(decoded_text, src='en', dest='zh-cn')
